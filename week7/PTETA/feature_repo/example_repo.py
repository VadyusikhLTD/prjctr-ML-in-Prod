...
bus_stats_source = FileSource(
    name="bus_hourly_stats_source",
    path="/home/vadym/PycharmProjects/prjctr-ML-in-Prod/week7/PTETA/feature_repo/data/driver_stats.parquet",
...
#     sources=[bus_stats_fv, input_request],
#     schema=[
